...
But this equation can not describe one-single particle, instead it can be used to describe a field--\tcb{scalar field}. The reason mainly comes from the second derivative respect to time.  Well let's see the details.\\
